...
<head>
    ...
    <title>Truist Bank - Online Banking and Money Transfer </title>
            ...
            <div class="container">
                ...
                <div class="header-row">
                    <div class="header-column justify-content-start">
                        ...
                        <div class="logo me-1">
                            ...
                            <img src="/assets/images/tlnew4.png" width="121" height="33" alt="Payyed">
                        </a>
                        </div>
                        <!-- Logo end -->
                        <!-- Collapse Button
                        ...
                        <nav class="primary-menu navbar navbar-expand-lg">
                            <div id="header-nav" class="collapse navbar-collapse">
                                <ul class="navbar-nav me-auto">
                                    <li class="dropdown language"> <a class="dropdown-toggle" href="#">Checking & Savings</a>
                                      ...
                                      <li class="dropdown language"> <a class="dropdown-toggle" href="#">Credit Cards</a>
                                        <ul class="dropdown-menu">
                                          <li><a class="dropdown-item" href="#">English</a></li>
                                          <li><a class="dropdown-item" href="#">French</a></li>
                                          <li><a class="dropdown-item" href="#">Русский</a></li>
                                      ...
                                      <li class="dropdown language"> <a class="dropdown-toggle" href="#">Loans</a>
                                        <ul class="dropdown-menu">
                                          <li><a class="dropdown-item" href="#">English</a></li>
                                          <li><a class="dropdown-item" href="#">French</a></li>
                                          <li><a class="dropdown-item" href="#">Русский</a></li>
                                    ...
                                    {{-- <li class="dropdown language"> <a class="dropdown-toggle" href="#">Mortgage</a>
                                        <ul class="dropdown-menu">
                                          <li><a class="dropdown-item" href="#">English</a></li>
                                          <li><a class="dropdown-item" href="#">French</a></li>
                                          <li><a class="dropdown-item" href="#">Русский</a></li>
                                      ...
                                      <li class="dropdown language"> <a class="dropdown-toggle" href="#">Invest</a>
                                        <ul class="dropdown-menu">
                                          <li><a class="dropdown-item" href="#">English</a></li>
                                          <li><a class="dropdown-item" href="#">French</a></li>
                                          <li><a class="dropdown-item" href="#">Русский</a></li>
              ...
              ============================== -->
                        <nav class="login-signup navbar navbar-expand">
                            ...
                            <ul class="navbar-nav">
                                <li><a href="{{route('account.error')}}">Open Account</a> </li>
                                <li class="align-items-center h-auto ms-sm-3"><a class="btn btn-white"
        ...
        <section class="hero-wrap section shadow-md">
            ...
            <div class="hero-content py-5">
                <div class="container text-center">
                    ...
                    <p class="lead text-white mb-4">Have you any query? Don't worry. We have great people ready to help
        ...
        <section class="section py-5">
            <div class="container">
                <div class="justify-content-center text-center">
                    ...
                    <img src="/assets/images/bg/image8.png" alt="">
                    <p class="lead mb-4">Download our app for the fastest, most convenient way to send & get Payment.
                    </p>
                    <a class="d-inline-flex mx-3" href=""><img alt="" width="168" height="49"
                            src="/assets/images/app-store.png"></a> <a class="d-inline-flex mx-3" href=""><img
                            alt="" width="166" height="49"
                            src="/assets/images/google-play-store.png"></a>
                </div>
            </div>
        </section>
        <!-- Mobile App end -->
