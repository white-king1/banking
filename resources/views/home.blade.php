    ...
    <div class="container">
      <div class="header-row">
        <div class="header-column justify-content-start">
          <!-- Logo
          ============================= -->
          <div class="logo me-3"> <a class="d-flex" href="{{route('home')}}" title="Payyed - HTML Template"><img src="assets/images/tlnew4.png" width="121" height="33" alt="Payyed"></a> </div>
          <!-- Logo end -->
          <!-- Collapse Button
          ============================== -->
        ...
        <div class="header-column justify-content-end">
          ...
          <nav class="login-signup navbar navbar-expand">
            <ul class="navbar-nav">
              ...
              <li class="align-items-center h-auto ms-sm-3"><a class="btn btn-white" href="{{ route('register') }}">Sign Up</a></li>
            </ul>
          </nav>
