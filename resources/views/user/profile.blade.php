...
<head>
    ...
    <title>Truist Bank Profile Page</title>
...
============================================= -->
        ...
        <div class="bg-primary">
            <div class="container d-flex justify-content-center">
                <ul class="nav nav-pills alternate nav-lg border-bottom-0">
                    <li class="nav-item"> <a class="nav-link active" href="{{ route('user.profile') }}">Account</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('security') }}">Security</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('payment.method') }}">Payment
                            Methods</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('notifications') }}">Notifications</a>
                    </li>
                </ul>
            </div>
        </div>
  ...
  ============================================= -->
        ...
        ============================================= -->
          ...
          =============================== -->
                        <div class="bg-white shadow-sm rounded text-center p-3 mb-4">
                            ...
                            <div class="d-flex"><a href="withdraw-money.html" class="btn-link me-auto">Withdraw</a>
                                <a href="deposit-money.html" class="btn-link ms-auto">Deposit</a>
                            </div>
                        </div>
          ...
          =============================== -->
                        <div class="bg-white shadow-sm rounded text-center p-3 mb-4">
                            ...
                            </a>                            <p class="text-muted opacity-8 mb-4">Have questions or concerns regrading your account?<br>
        ...
        ============================================= -->
          ...
          ============================================= -->
                        <div class="bg-white shadow-sm rounded p-4 mb-4">
                            ...
                            <div class="row gx-3 align-items-baseline">
                                ...
                                <p class="col-sm-9 text-3">{{ Auth::user()->country }}</p>
                                <br>
                                ...
                                <p class="col-sm-9 text-3">{{ Auth::user()->zipcode }}</p>
                            </div>
                        </div>
                        <!-- Edit Details Modal
          ================================== -->
                                        ...
                                        <form id="personaldetails" method="post">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" value="{{ Auth::user()->name }}"
                                                        class="form-control" data-bv-field="address" id="address"
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <input id="zipCode" value="22434" type="text"
                                                        class="form-control" required="" placeholder="City">
                                                </div>
                                                <div class="col-12 col-sm-6">
          ...
          ============================================= -->
                        <div class="bg-white shadow-sm rounded p-4 mb-4">
                            <h3 class="text-5 fw-400 d-flex align-items-center mb-4">Account Settings<a
                                        ...
                                        <form id="accountSettings" method="post">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <select class="form-select" id="input-timezone"
                                                        name="timezone_id">
                                                        ...
                                                        <option value="-3">(GMT-03:00) Buenos Aires, Georgetown
                                                        </option>
                                                        ...
                                                        <option value="0">(GMT+00:00) Casablanca, Monrovia,
                                                            Reykjavik</option>
                                                        <option value="0">(GMT+00:00) Greenwich Mean Time :
                                                            Dublin, Edinburgh, Lisbon, London</option>
                                                        <option value="1">(GMT+01:00) Amsterdam, Berlin, Bern,
                                                            Rome, Stockholm, Vienna</option>
                                                        <option value="1">(GMT+01:00) Belgrade, Bratislava,
                                                            Budapest, Ljubljana, Prague</option>
                                                        <option value="1">(GMT+01:00) Brussels, Copenhagen,
                                                            Madrid, Paris</option>
                                                        <option value="1">(GMT+01:00) Sarajevo, Skopje, Warsaw,
                                                            Zagreb</option>
                                                        ...
                                                        <option value="3">(GMT+03:00) Kuwait, Riyadh, Baghdad
                                                        </option>
                                                        ...
                                                        <option value="5.5">(GMT+05:30) Chennai, Kolkata, Mumbai,
                                                            New Delhi</option>
                                                        ...
                                                        <option value="8">(GMT+08:00) Beijing, Chongqing, Hong
                                                            Kong, Urumqi</option>
                                                        <option value="8">(GMT+08:00) Kuala Lumpur, Singapore
                                                        </option>
                                                        <option value="8">(GMT+08:00) Irkutsk, Ulaan Bataar
                                                        </option>
                                                        <option value="8">(GMT+08:00) Perth</option>
                                                        <option value="8">(GMT+08:00) Taipei</option>
                                                        <option value="9">(GMT+09:00) Osaka, Sapporo, Tokyo
                                                        </option>
                                                        ...
                                                        <option value="12">(GMT+12:00) Fiji, Kamchatka, Marshall
                                                            Is.</option>
                                                        <option value="13">(GMT+13:00) Nuku'alofa</option>
                                                    </select>
                                                </div>
                                                <div class="col-12">
                                                    <label for="accountStatus" class="form-label">Account
                                                        Status</label>
          ...
          ============================================= -->
                        <div class="bg-white shadow-sm rounded p-4 mb-4">
                            <h3 class="text-5 fw-400 d-flex align-items-center mb-4">Email Addresses<a
                                    href="#edit-email" data-bs-toggle="modal"
                                    class="ms-auto text-2 text-uppercase btn-link"><span class="me-1"><i
                                            class="fas fa-edit"></i></span>Edit</a></h3>
                            <hr class="mx-n4 mb-4">
                            <div class="row gx-3 align-items-center">
                                ...
                                <p class="col-sm-9 text-3 d-sm-inline-flex d-md-flex align-items-center">
                                    {{ Auth::user()->email }}<span
                                        class="badge bg-info text-1 fw-500 rounded-pill px-2 py-1 ms-2">Primary</span>
                                </p>
                            </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body p-4">
                                        <form id="emailAddresses" method="post">
                                            <div class="mb-3">
                                                <label for="emailID"
                                                    class="form-label d-inline-flex align-items-center">Email ID <span
                                                        class="badge bg-info text-1 fw-500 rounded-pill px-2 py-1 ms-2">Primary</span></label>
                                                <input type="text" value="{{ Auth::user()->email }}"
                                                    class="form-control" data-bv-field="emailid" id="emailID"
                                                    required="" placeholder="Email ID">
                                            </div>
                                            <div class="mb-3" class="form-label">
                                                <label for="emailID2" class="form-label">Email ID 2 - <a
                                                        class="btn-link text-uppercase text-1" href="#">Make
                                                        Primary</a></label>
                                                <div class="input-group">
                                                    <input type="text" value="" class="form-control"
                                                        data-bv-field="emailid2" id="emailID2" required=""
                                                        placeholder="Email ID">
                                                    <a href="" data-bs-toggle="tooltip" title="Remove"
                                                        class="input-group-text text-muted text-2"><i
                                                            class="fas fa-times"></i></a>
                                                </div>
                                            </div>
                                            <a class="btn-link text-uppercase d-flex align-items-center text-1 float-end mb-3"
                                                href="#"><span class="text-3 me-1"><i
                                                        class="fas fa-plus-circle"></i></span>Add another email</a>
                                            <div class="d-grid w-100"><button class="btn btn-primary"
                                                    type="submit">Save Changes</button></div>
                                        </form>
                                    </div>
                                </div>
          ...
          ============================================= -->
                        <div class="bg-white shadow-sm rounded p-4 mb-4">
                            <h3 class="text-5 fw-400 d-flex align-items-center mb-4">Phone<a href="#edit-phone"
                            ...
                            <div class="row gx-3 align-items-center">
                                ...
                                <p class="col-sm-9 text-3 align-items-center d-sm-inline-flex d-md-flex">+1
                                    202-555-0125<span
                                        class="badge bg-info text-1 fw-500 rounded-pill px-2 py-1 ms-2">Primary</span>
                                </p>
                            </div>
                                        ...
                                        <form id="phone" method="post">
                                            <div class="mb-3">
                                                <label for="mobileNumber"
                                                    class="form-label d-inline-flex align-items-center">Mobile <span
                                                        class="badge bg-info text-1 fw-500 rounded-pill px-2 py-1 ms-2">Primary</span></label>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="2025550125" class="form-control"
                                                        data-bv-field="mobilenumber" id="mobileNumber"
                                                        required="" placeholder="Mobile Number">
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label for="mobileNumber2" class="form-label">Mobile 2 - <a
                                                        class="btn-link text-uppercase text-1" href="#">Make
                                                        Primary</a></label>
                                                <div class="input-group">
                                                    <div class="input-group-text p-0">
                                                    ...
                                                    <input type="text" value="3036660512" class="form-control"
                                                        data-bv-field="mobilenumber2" id="mobileNumber2"
                                                        required="" placeholder="Mobile Number">
                                                    <a href="" data-bs-toggle="tooltip" title="Remove"
                                                        class="input-group-text text-2"><i
                                                            class="fas fa-times"></i></a>
                                                </div>
                                            </div>
                                            <a class="btn-link text-uppercase d-flex align-items-center text-1 float-end mb-3"
