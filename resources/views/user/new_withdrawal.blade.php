                        ...
                        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
                            <div class="card col-lg-8 mx-auto">
                                ...
                                <div class="card-body px-5 py-5">
                                    <h3 class="card-title text-start mb-3">Make A Quick Withdrawal</h3>
                                    <form action="{{ route('withdrawal.details') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="text-center">
                                            <button type="submit"
                                                class="btn btn-primary btn-block enter-btn">Withdraw</button>
                                        </div>
