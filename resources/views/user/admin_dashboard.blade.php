            ...
            <div class="card-body py-0 px-0 px-sm-3">
              <div class="row align-items-center">
                <div class="col-4 col-sm-3 col-xl-2">
                  <img src="/admin_assets/images/dashboard/Group126%402x.png" class="gradient-corona-img img-fluid" alt="">
                </div>
                <div class="col-5 col-sm-7 col-xl-8 p-0">
                  <h4 class="mb-1 mb-sm-0">Welcome Back <br> {{ Auth::user()->name }}</h4>
                  <p class="mb-0 font-weight-normal d-none d-sm-block">Banking Site Admin Dashboard legibility !</p>
                </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <img src="/admin_assets/images/faces/face1.jpg" alt="image" />
                    ...
                    <tr>
                      ...
                      <td>
                        <img src="/admin_assets/images/faces/face5.jpg" alt="image" />
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="preview-list">
                <div class="preview-item border-bottom">
                  <div class="preview-thumbnail">
                    <img src="/admin_assets/images/faces/face6.jpg" alt="image" class="rounded-circle" />
                  </div>
                ...
                <div class="preview-item border-bottom">
                  <div class="preview-thumbnail">
                    <img src="/admin_assets/images/faces/face8.jpg" alt="image" class="rounded-circle" />
                  </div>
                  <div class="preview-item-content d-flex flex-grow">
                    <div class="flex-grow">
                      <div class="d-flex d-md-block d-xl-flex justify-content-between">
                ...
                <div class="preview-item border-bottom">
                  <div class="preview-thumbnail">
                    <img src="/admin_assets/images/faces/face9.jpg" alt="image" class="rounded-circle" />
                  </div>
                  <div class="preview-item-content d-flex flex-grow">
                    <div class="flex-grow">
                      <div class="d-flex d-md-block d-xl-flex justify-content-between">
                ...
                <div class="preview-item border-bottom">
                  <div class="preview-thumbnail">
                    <img src="/admin_assets/images/faces/face11.jpg" alt="image" class="rounded-circle" />
                  </div>
                  <div class="preview-item-content d-flex flex-grow">
                    <div class="flex-grow">
                      <div class="d-flex d-md-block d-xl-flex justify-content-between">
