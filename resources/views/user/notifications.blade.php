...
<head>
    ...
    <title>Truist Bank - Notification Page</title>
          ...
          ============================================= -->
                        <div class="bg-white shadow-sm rounded p-4 mb-4">
                            ...
                            <p class="text-muted">Select subscriptions to be delivered to <span
                                    class="text-body">{{Auth::user()->email}}</span></p>
                            <hr class="mx-n4">
                            <form id="notifications" method="post">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="announcements" name="notifications"
                                        type="checkbox">
                                    <label class="form-check-label text-3" for="announcements">Announcements</label>
                                    <p class="text-muted lh-base mt-2 mb-0">Be the first to know about new features and
                                        other news.</p>
                                </div>
                                <hr class="mx-n4">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="sendPayment" name="notifications"
                                        type="checkbox">
                                ...
                                <hr class="mx-n4">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="receiveApayment" name="notifications"
                                        type="checkbox">
                                    <label class="form-check-label text-3" for="receiveApayment">Receive a
                                        payment</label>
                                    <p class="text-muted lh-base mt-2 mb-0">Send me an email when I receive a payment.
                                    </p>
                                </div>
                                <hr class="mx-n4">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="requestPayment" name="notifications"
                                        type="checkbox">
                                    <label class="form-check-label text-3" for="requestPayment">Request
                                        payment</label>
                                    <p class="text-muted lh-base mt-2 mb-0">Send me an email when i request payment.
                                    </p>
                                </div>
                                <hr class="mx-n4">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="problemWithPayment" name="notifications"
                                        type="checkbox">
                                    <label class="form-check-label text-3" for="problemWithPayment">Have a problem
                                        with a payment</label>
                                    <p class="text-muted lh-base mt-2 mb-0">Send me an email when have a problem with a
                                        payment.</p>
                                </div>
                                <hr class="mx-n4">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="specialOffers" name="notifications"
                                        type="checkbox">
                                ...
                                <hr class="mx-n4">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="reviewSurveys" name="notifications"
                                        type="checkbox">
                                    <label class="form-check-label text-3" for="reviewSurveys">Review Surveys</label>
                                    <p class="text-muted lh-base mt-2 mb-0">Share your payment experience to better
                                        inform users.</p>
                                </div>
                                <hr class="mx-n4">
